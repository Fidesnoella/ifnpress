...
export default function LatestNews({ img, title, text, date, handleClick } : GeneralProps):JSX.Element {
    ...
    return (
        <div className={`${mode === 'light' ? "bg-white hover:bg-[#e3e2e0]" : 'bg-black hover:bg-[#3c3c3d]' } max-w-none sm:max-w-lg md:max-w-sm cursor-pointer mx-3 sm:mx-0 overflow-hidden`}
            onClick={handleClick}>
