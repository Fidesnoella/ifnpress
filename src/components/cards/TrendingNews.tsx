...
export default function TrendingNews({ img, title, date, text, last = false, handleClick }: LatestNewsType):JSX.Element { 
    ...
    return (
        <div className={` border-gray-400 ${last ? "border-0" : "border-b"} ${mode === 'light' ? "hover:bg-[#e3e2e0]" : "hover:bg-[#3c3c3d]"} cursor-pointer`} onClick={handleClick}>
            <div className="grid grid-cols-2 gap-2 w-full relative overflow-hidden">
                ...
                <div className="flex flex-col gap-3">
                    <h2 className="mb-2 pt-1 text-sm xss:text-base sm:text-lg lg:text-base font-bold tracking-tight text-gray-500">
